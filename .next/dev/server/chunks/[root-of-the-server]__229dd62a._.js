...
"[project]/src/app/api/user/progress/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getUserFromRequest = async (req)=>{
    ...
    try {
        const decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET || 'fallback_secret');
        return decoded.user;
    } catch (err) {
        return null;
    }
...
async function POST(req) {
    ...
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(userDecoded.id);
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                msg: 'User not found'
            }, {
        ...
        if (!Array.isArray(completedLessons)) {
            completedLessons = [];
            user.set('completedLessons', completedLessons, {
                strict: false
            });
        }
        ...
        if (currentLesson === undefined || currentLesson === null) {
            currentLesson = 1;
            user.set('currentLesson', currentLesson, {
                strict: false
            });
        }
        if (completed) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__229dd62a._.js.map