...
"[project]/src/app/api/user/challenge/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        if (!budgetChallenge) {
            ...
            user.set('budgetChallenge', budgetChallenge, {
                strict: false
            });
        }
        if (action === 'start') {
            ...
            user.set('budgetChallenge', newChallenge, {
                strict: false
            });
            ...
            user.set('budgetChallenge', updatedChallenge, {
                strict: false
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__26477ceb._.js.map