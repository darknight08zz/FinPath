...
async function GET(req) {
    try {
        ...
        try {
            ...
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(decoded.user.id).select('-password');
            if (!user) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    msg: 'User not found'
                }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5979abed._.js.map