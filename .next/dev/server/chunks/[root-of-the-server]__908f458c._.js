...
async function GET() {
    try {
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).select('username xp level badges streak').sort({
            xp: -1
        }).limit(10);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__908f458c._.js.map